Function Remove-PSADOApi {
    <#
    .SYNOPSIS
    Function to connect with the Azure DevOps REST API with the Delete-method
    ...
    .EXAMPLE
    Delete-PSADOApi -Uri "https://dev.azure.com/$Organization/_apis/projects?api-version=5.0" -Header $Header -Body $Body
